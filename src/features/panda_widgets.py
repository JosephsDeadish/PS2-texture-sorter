...
class WidgetCollection:
    ...
    DEFAULT_WIDGETS = {
        ...
        'rubber_duck': ToyWidget('Squeaky Rubber Duck', '🦆', WidgetRarity.COMMON,
                                 physics=ItemPhysics(bounciness=1.3, weight=0.3, wobble=0.6,
                                                    friction=0.90, gravity=1.3)),
        'teddy_bear': ToyWidget('Fluffy Teddy Bear', '🧸', WidgetRarity.UNCOMMON,
                               physics=ItemPhysics(bounciness=0.4, weight=0.6, wobble=0.7,
                                                  elasticity=0.6, friction=0.85)),
        'boomerang': ToyWidget('Bamboo Boomerang', '🪃', WidgetRarity.RARE,
                              physics=ItemPhysics(bounciness=0.7, weight=0.4, friction=0.98,
                                                 gravity=0.6)),
        'magic_wand': ToyWidget('Sparkle Magic Wand', '🪄', WidgetRarity.EPIC,
                               physics=ItemPhysics(bounciness=0.2, weight=0.3, wobble=0.4,
                                                  friction=0.94)),
        'pinwheel': ToyWidget('Spinning Pinwheel', '🎡', WidgetRarity.UNCOMMON,
                             physics=ItemPhysics(bounciness=0.5, weight=0.2, friction=0.96,
                                                gravity=0.8, wobble=0.5)),
        'soap_bubbles': ToyWidget('Bubble Wand', '🫧', WidgetRarity.COMMON,
                                  physics=ItemPhysics(bounciness=0.1, weight=0.1, friction=0.99,
                                                     gravity=0.1, wobble=0.9)),
        'toy_car': ToyWidget('Racing Toy Car', '🏎️', WidgetRarity.UNCOMMON,
                            physics=ItemPhysics(bounciness=0.6, weight=0.8, friction=0.88,
                                               gravity=1.8)),
        'rubber_ring': ToyWidget('Bouncy Rubber Ring', '⭕', WidgetRarity.COMMON,
                                physics=ItemPhysics(bounciness=2.2, weight=0.3, bounce_damping=0.8,
                                                   wobble=0.6, elasticity=0.85, springiness=0.7)),
        'wooden_blocks': ToyWidget('Wooden Building Blocks', '🧱', WidgetRarity.COMMON,
                                   physics=ItemPhysics(bounciness=0.3, weight=1.5, friction=0.80,
                                                      gravity=2.2)),
        'beach_ball': ToyWidget('Inflatable Beach Ball', '🏐', WidgetRarity.UNCOMMON,
                               physics=ItemPhysics(bounciness=2.8, weight=0.2, bounce_damping=0.85,
                                                  wobble=0.8, friction=0.95, gravity=0.5)),
        'jump_rope': ToyWidget('Jump Rope', '🪢', WidgetRarity.COMMON,
                              physics=ItemPhysics(bounciness=0.4, weight=0.5, wobble=0.9,
                                                 elasticity=0.8, springiness=0.6, friction=0.90)),
        'toy_sword': ToyWidget('Foam Toy Sword', '🗡️', WidgetRarity.RARE,
                              physics=ItemPhysics(bounciness=0.5, weight=0.4, wobble=0.5,
                                                 elasticity=0.4, friction=0.92)),
        'balloon': ToyWidget('Helium Balloon', '🎈', WidgetRarity.COMMON,
                            physics=ItemPhysics(bounciness=1.5, weight=0.05, friction=0.98,
                                               gravity=-0.3, wobble=0.95)),  # Negative gravity = floats up!
        'top_spinner': ToyWidget('Spinning Top', '🌀', WidgetRarity.UNCOMMON,
                                physics=ItemPhysics(bounciness=0.8, weight=0.6, friction=0.85,
                                                   gravity=2.0)),
        'dice': ToyWidget('Lucky Dice', '🎲', WidgetRarity.COMMON,
                         physics=ItemPhysics(bounciness=1.2, weight=0.4, friction=0.88)),
        'paper_airplane': ToyWidget('Paper Airplane', '✈️', WidgetRarity.COMMON,
                                    physics=ItemPhysics(bounciness=0.2, weight=0.1, friction=0.97,
                                                       gravity=0.4, wobble=0.7)),
        'bowling_pin': ToyWidget('Toy Bowling Pin', '🎳', WidgetRarity.UNCOMMON,
                                physics=ItemPhysics(bounciness=0.6, weight=1.2, friction=0.82,
                                                   gravity=2.0, wobble=0.3)),
        'music_box': ToyWidget('Wind-Up Music Box', '🎵', WidgetRarity.RARE,
                              physics=ItemPhysics(bounciness=0.3, weight=1.0, friction=0.86,
                                                 gravity=1.8)),
        'spring_toy': ToyWidget('Bouncy Spring Toy', '〰️', WidgetRarity.UNCOMMON,
                               physics=ItemPhysics(bounciness=2.5, weight=0.5, bounce_damping=0.75,
                                                  wobble=0.8, elasticity=0.9, springiness=0.95,
                                                  friction=0.88)),
        'feather': ToyWidget('Soft Feather', '🪶', WidgetRarity.COMMON,
                            physics=ItemPhysics(bounciness=0.1, weight=0.05, friction=0.99,
                                               gravity=0.2, wobble=0.95)),
        'crystal_ball': ToyWidget('Magic Crystal Ball', '🔮', WidgetRarity.LEGENDARY,
                                  physics=ItemPhysics(bounciness=0.9, weight=2.0, friction=0.92,
                                                     gravity=2.5, wobble=0.1)),
        'hourglass': ToyWidget('Sand Hourglass', '⏳', WidgetRarity.RARE,
                              physics=ItemPhysics(bounciness=0.2, weight=1.3, friction=0.85,
                                                 gravity=2.2, wobble=0.2)),
        'magnet': ToyWidget('Super Magnet', '🧲', WidgetRarity.EPIC,
                           physics=ItemPhysics(bounciness=0.4, weight=1.8, friction=0.88,
                                              gravity=2.4, wobble=0.1)),
        'trophy': ToyWidget('Golden Trophy', '🏆', WidgetRarity.LEGENDARY,
                           physics=ItemPhysics(bounciness=0.5, weight=2.2, friction=0.84,
                                              gravity=2.6, wobble=0.15, causes_crack=True)),
        'anchor': ToyWidget('Heavy Anchor', '⚓', WidgetRarity.EPIC,
                           physics=ItemPhysics(bounciness=0.1, weight=4.0, friction=0.75,
                                              gravity=4.0, wobble=0.05, kickable=False,
                                              hurt_on_kick=True, causes_crack=True)),
